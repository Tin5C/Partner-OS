...
const EXECUTIVE: BusinessPlayPackage = {
  ...
  business: {
    deal_strategy: {
      what: 'Position WinWire as the FinOps and AI-readiness partner for Schindler\'s Azure estate, leveraging Swiss data-residency compliance and Copilot field-service automation as the dual entry wedge.',
      how: [
    ...
    positioning: {
      executive_pov: 'Schindler needs a partner who can deliver measurable cloud ROI today while building the AI-ready foundation required by 2027. Generic cloud resellers optimise VMs — WinWire optimises business outcomes across FinOps, data platforms, and applied AI, all within Swiss compliance boundaries.',
      talk_tracks: [
...
seedBusinessPlayPackages([EXECUTIVE, GROUNDED]);
