    ...
    return (
      ...
      >
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="w-11 h-11 rounded-xl bg-teal-100 dark:bg-teal-900/40 flex items-center justify-center shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
  ...
  return (
    <>
      ...
      >
        ...
        {/* Subtitle */}
        <p className="text-[13px] text-muted-foreground line-clamp-1 mb-4 leading-relaxed">
          Personalized to your skills
        </p>
